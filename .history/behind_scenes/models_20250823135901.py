...
class BTSPage(Page):
    ...
    Independent from Written/Audio/Video models (per brief).
    """
    template = "bts_page.html"

    # categorisation so category pages can show the right teasers
    ...
    # optional SHORT teaser fields (used by cards on index + category pages)
    ...
    # --- convenience for templates / serializers ---
