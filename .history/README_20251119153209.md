...
To maintain clarity and structure, we applied the **MoSCoW prioritization framework**, categorising tasks into:

- **Must Have** – core content structure, navigation, hero system, service pages, and journalism sections  
- **Should Have** – BTS area, animation enhancements, unified button & ribbon system  
- **Could Have** – extended multimedia features, additional service modules, future layout templates  
- **Won’t Have (for this release)** – larger expansions planned for a future sprint  
