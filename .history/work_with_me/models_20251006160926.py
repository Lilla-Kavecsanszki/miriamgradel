...
# --- Use Cloudinary RAW storage for .vcf when available ---
...
if os.getenv("CLOUDINARY_URL"):
    try:
        ...
        VCARD_FILEFIELD_KW["storage"] = RawMediaCloudinaryStorage()
    except Exception:
        # Fallback silently to default storage if Raw storage isn't available
        pass
...
class WorkWithMePage(AbstractEmailForm):
    ...
    def _absolute_url(self, path_or_url: str) -> str:
        """
        Ensure an absolute URL. Cloudinary gives absolute URLs already; local media may be /media/...
        """
        if not path_or_url:
            return ""
    ...
    def get_qr_payload(self) -> str:
        """
        Pick the most useful payload for the QR:
    ...
    def save(self, *args, **kwargs):
        ...
        # Seed some sensible default form fields on first create
